...
class Item(db.Model, SerializerMixin):
    ...
    #Relationship mapping the item to the related review
...
class Review(db.Model, SerializerMixin):
    ...
    #Relationship mapping the review to the related customer
    customer = db.relationship('Customer', back_populates = 'reviews')

    #Relationship mapping the review to the related item
